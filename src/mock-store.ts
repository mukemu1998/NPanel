...
const mockState: {
	...
	groups: [
		{
			...
			slug: "starter",
			enabled: true,
			subscriptionToken: "demo-starter-group",
	...
	groupMembers: [
		{
			groupId: "group-starter",
			nodeId: "node-primary-direct",
			displayName: "Primary-Direct",
			sortOrder: 10,
		},
		{
			groupId: "group-starter",
			nodeId: "node-primary-relay",
